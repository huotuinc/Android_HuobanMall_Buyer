package com.huotu.mall.yingyan.wxapi;
...
class WXPayEntryActivity extends Activity implements Handler.Callback, IWXAPIEventHandler {
    ...
    void onResp ( BaseResp resp ) {
        ...
        Loger.i ( "onPayFinish, errCode = " + resp.errCode );
        ...
        if (resp.getType() == ConstantsAPI.COMMAND_PAY_BY_WX) {
            ...
            if(null==payResp){
                Loger.i("wxpay>>>payResp=null","");
                msg="支付失败";
                ToastUtils.showLongToast(WXPayEntryActivity.this, msg);
                this.finish();
                return;
            }else{
               Loger.i("wxpay>>>extData", payResp.extData==null? "": payResp.extData );
