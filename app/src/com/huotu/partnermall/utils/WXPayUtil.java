...
class WXPayUtil {
    ...
    public
    WXPayUtil ( Context context, Handler handler, BaseApplication application ) {
    ...
    void pay ( String body, String fee ) {
        ...
        api = WXAPIFactory.createWXAPI ( context, Constants.WXPAY_ID );
    ...
    private void sendPayReq(GetPrepayIdResult result)
    {
        ...
        Log.i ("info", "调起支付的package串：" + req.packageValue );
    ...
    private GetPrepayIdResult sendPrePayReq(String accessToken)
    {
        ...
        Log.i( "info", " prePay content = " + content);
    ...
    private GetAccessTokenResult getAccessToken()
    {
        ...
        if (AccessToken == null || AccessToken.length()<1 || second > 5400)
        {
            ...
            Log.i("info","get access token, url = " + url);
    ...
    private String genProductArgs()
    {
        ...
        try
        {
            json.put("appid", Constants.WXPAY_ID);
            // traceId
            ...
            List<NameValuePair> signParams = new LinkedList<NameValuePair>();
            signParams.add(new BasicNameValuePair("appid", Constants.WXPAY_ID));
            signParams.add(new BasicNameValuePair("appkey", APP_KEY));
        ...
        {
            Log.i( "error","genProductArgs fail, ex = " + e.getMessage());
            return null;
        }
    ...
    private String genSign(List<NameValuePair> params)
    {
        ...
        Log.i ("info", "sha1签名串：" + sb.toString ( ) );
        Log.i ( "info", "genSign, sha1 = " + sha1 );
        return sha1;
    }
    ...
    private String genPackage(List<NameValuePair> params)
    {
        ...
        //Loger.i ( "package签名串：" + sb.toString ( ) );
    ...
    public static byte[] httpPost(String url, String entity)
    {
        ...
        try
        {
            ...
            {
                //Loger.i( "httpGet fail, status code = " + resp.getStatusLine().getStatusCode());
                return null;
            }
        ...
        {
            //Loger.i( "httpPost exception, e = " + e.getMessage());
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static byte[] httpGet(final String url) {
        ...
        try {
            ...
            //Loger.i( "httpGet exception, e = " + e.getMessage());
            e.printStackTrace();
            return null;
        }
    }
    ...
    private static class GetAccessTokenResult
    {
        ...
        public void parseFrom(String content)
        {
            ...
            {
                //Loger.i( "parseFrom fail, content is null");
