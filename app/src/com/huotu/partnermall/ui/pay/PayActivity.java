...
class PayActivity extends BaseActivity {
    ...
    private class GetAccessTokenTask extends AsyncTask<Void, Void, GetAccessTokenResult> {
        ...
        void onPostExecute ( GetAccessTokenResult result ) {
            ...
            if ( result.localRetCode == LocalRetCode.ERR_OK ) {
                ...
                //Loger.i ( "onPostExecute, accessToken = " + result.accessToken );
        ...
        GetAccessTokenResult doInBackground ( Void... params ) {
            ...
            //Loger.i ( "get access token, url = " + url );
    ...
    class GetPrepayIdTask extends AsyncTask< Void, Void, GetPrepayIdResult > {
        ...
        protected GetPrepayIdResult doInBackground(Void... params) {
            ...
            //Loger.i ( "doInBackground, url = " + url );
            //Loger.i ( "doInBackground, entity = " + entity );
            ...
            String content = new String(buf);
            //Loger.i( "doInBackground, content = " + content );
            result.parseFrom(content);
            return result;
        }
    }
