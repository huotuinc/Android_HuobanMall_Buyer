...
package com.huotu.partnermall.onekeyshare.theme.skyblue;

import android.os.AsyncTask;
import android.view.View;
import android.widget.GridView;

import com.huotu.partnermall.onekeyshare.PlatformListFakeActivity;
...
public class PlatformListPage extends PlatformListFakeActivity implements View.OnClickListener {
	...
	private void onShareButtonClick(View v) {
		...
		if(checkedPlatforms.size() == 0){
			ToastUtils.showShortToast ( activity, String.valueOf ( getStringRes ( activity, "select_one_plat_at_least" )));
			return;
		}
