...
import com.huotu.partnermall.onekeyshare.EditPageFakeActivity;
import com.huotu.partnermall.onekeyshare.PicViewer;
import com.huotu.partnermall.onekeyshare.ShareCore;
		...
		llAt.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if(platforms != null && platforms.size() > 0){
					...
					if (resId > 0) {
						ToastUtils.showShortToast ( getContext ( ), String.valueOf ( resId ) );
					}
				}
			}
		});
