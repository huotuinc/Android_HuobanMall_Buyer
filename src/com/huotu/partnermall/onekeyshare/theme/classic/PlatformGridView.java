...
package com.huotu.partnermall.onekeyshare.theme.classic;
...
import com.huotu.partnermall.onekeyshare.CustomerLogo;
...
public class PlatformGridView extends LinearLayout implements
	...
	void init ( final Context context ) {
		...
		pager.setLayoutParams ( new LayoutParams ( LayoutParams.MATCH_PARENT, LayoutParams
										.WRAP_CONTENT ) );
		addView ( pager );
	...
	private static class GridView extends LinearLayout {
		...
		private void init() {
			...
			setPadding(dp_5, dp_5, dp_5, dp_5);
			setOrientation(VERTICAL);
			...
			for (int i = 0; i < lines; i++) {
				...
				llLine.setPadding(dp_5, dp_5, dp_5, dp_5);
				addView(llLine);
