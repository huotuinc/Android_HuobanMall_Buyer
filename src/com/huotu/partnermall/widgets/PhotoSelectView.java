...
class PhotoSelectView {
    ...
    public
    PhotoSelectView ( Context context, OnPhotoSelectBackListener listener ) {
        initView ( context );
        this.listener = listener;
    }

    public
    void setOnPhotoSelectBackListener ( OnPhotoSelectBackListener listener ) {
        this.listener = listener;
    }
