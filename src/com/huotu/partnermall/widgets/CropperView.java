...
class CropperView {
    ...
    public
    CropperView ( Context context, OnCropperBackListener listener ) {
     ...
     */
    public
    void cropper ( Bitmap source ) {
        if ( source == null )
            return;
        changSize = false;
        KJLoger.i ( ">>>>>>>>0:" + source.getWidth ( ) + "," + source.getHeight ( ) );
        ...
        KJLoger.i(">>>>>>>>1:" + mOutWidth + "," + mOutHeight);
