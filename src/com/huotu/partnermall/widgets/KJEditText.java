 ...
 */
public
class KJEditText extends AutoCompleteTextView implements Handler.Callback {
    ...
    boolean handleMessage ( Message msg ) {
        if ( ! isFocusable ( ) )
            return true;
        KJEditText.this.setCompoundDrawables ( KJEditText.this.getCompoundDrawables ( )[ 0 ],
                                               KJEditText.this.getCompoundDrawables ( )[ 1 ],
                                               null, KJEditText.this.getCompoundDrawables ( )[ 3
                                                       ] );
        if ( msg.obj != null )
            KJEditText.this.setCompoundDrawables ( KJEditText.this.getCompoundDrawables ( )[ 0 ],
                                                   KJEditText.this.getCompoundDrawables ( )[ 1 ], ( Drawable ) msg.obj, KJEditText.this.getCompoundDrawables ( )[3]);
...
//		}
    ...
    public KJEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public KJEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void init(Context context, AttributeSet attrs){
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.KJEditText);
    ...
    {
        return TypedValue.applyDimension ( TypedValue.COMPLEX_UNIT_DIP, paramFloat, paramContext
